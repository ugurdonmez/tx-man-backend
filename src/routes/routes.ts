...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/accounts/:account_id',
            ...
            const args = {
                    account_id: {"in":"path","name":"account_id","required":true,"dataType":"string"},
            };
        ...
        app.get('/transactions',
            ...
            function TransactionController_getTransactions(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/transactions',
            ...
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"Transaction"},
            };
